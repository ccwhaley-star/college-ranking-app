...
const initialSchools = [
  ...
  },
  {
    ...
    shortName: "MSU",
    location: "Bozeman, MT",
    logo: "/logos/montanastate.png",
    schoolColor: "#00205B",
    isKansas: false,
    hasMaterialsEng: false,
    nicheGrade: "B+",
    nicheRank: "#403 National",
    usNewsRank: "#318 National Universities",
    materialsEngRank: "N/A — graduate only",
    tuitionRoomBoard: 48262,
    scholarships: [
    ...
    notes: {
      ...
      academic:
        "No dedicated Materials Engineering undergraduate degree — Materials Science is graduate-level only (MS/PhD in collaboration with Montana Tech). Strong undergraduate programs in Mechanical, Chemical, Civil, and Electrical Engineering. US News #135 Best Undergraduate Engineering Programs.",
      townVibe:
        "Bozeman is an eclectic, outdoorsy mountain town — progressive and hip with excellent outdoor access. Bridger Bowl ski area 30 min away, Big Sky Resort 1 hour. World-class hiking, skiing, and mountain culture. Craft beer scene, trendy restaurants, and strong community feel. Median age ~27-28.",
      townVibeSource: "Niche.com, Lonely Planet Bozeman, MSU student reviews, Visit Bozeman",
      medianIncome:
        "MSU engineering grads earn ~$62,208/yr starting salary. Mechanical Engineering median: ~$68,469/yr. Range by discipline: $59,000–$71,000. No Materials Eng undergrad program — income reflects general engineering outcomes.",
      medianIncomeSource: "PayScale, MSU Career Services, College Factual",
      roi:
        "4-year cost after scholarship: ~$133,048. Good engineering school with solid starting salaries ($62k). No Materials Eng undergrad degree limits specialization. Bozeman's growing tech scene improves job prospects. Better value than U of Montana for engineering.",
      roiSource: "Calculated from MSU tuition data and PayScale salary data",
      nationalRanking:
